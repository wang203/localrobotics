...
project = u'Cloud Robotics'
copyright = u'2014, Robotics, please contact Oliver Lewis(lewiso@indiana.edu) about this manual.'
...
htmlhelp_basename = 'CloudRoboticsdoc'
...
man_pages = [
    ('index', 'CloudRobotics', u'CloudRobotics Documentation',
     [u'Oliver Lewis'], 1)
]
...
texinfo_documents = [
    ('index', 'CloudRobotics', u'CloudRobotics Documentation',
     u'Oliver Lewis', 'CloudRobotics', 'One line description of project.',
     'Miscellaneous'),
]
...
epub_title = u'CloudRobotics'
epub_author = u'Oliver Lewis'
epub_publisher = u'Oliver Lewis'
epub_copyright = u'2014, Oliver Lewis'
